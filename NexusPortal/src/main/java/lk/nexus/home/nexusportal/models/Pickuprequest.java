...
//	private Register reg;
	...
	public Pickuprequest(Long reqid, String clientid, String clientname, String vehicletype, String pickuptime,
			String contactno, String noofpickups, Long assignuser, String ispickuprequestsuccess) {
		super();
		this.reqid = reqid;
...
//	}
	...
	public String toString() {
		return "Pickuprequest [reqid=" + reqid + ", clientid=" + clientid + ", clientname=" + clientname
				...
				+ ", noofpickups=" + noofpickups + ", assignuser=" + assignuser + ", ispickuprequestsuccess="
				+ ispickuprequestsuccess + "]";
	}



//https://roytuts.com/spring-boot-data-jpa-left-right-inner-and-cross-join-examples-on-three-tables/
